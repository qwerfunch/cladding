...
This is the **vanilla** group's React + Vite + TS + Tailwind task-manager — auto-generated by
...
with cladding governance. Compare the two trees to see what cladding adds:
