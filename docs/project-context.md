...
To make AI-coupled development **measurably safer and more honest** than vanilla AI coding. Honest = drift becomes visible; measurable = 31 detectors fire actionable findings; safer = the Iron Law gates fail CI when artifacts diverge from code reality.
