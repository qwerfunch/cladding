...
cladding is the reference implementation of the [Ironclad](https://github.com/qwerfunch/ironclad) standard. Multi-agent dev harness; 13 Iron Law stages; 28 drift detectors; polyglot toolchain (9 languages). Successor to harness-boot.
