...
/** Marker prepended to greenfield seed bodies so the reader knows. */
const SEED_HEADER = (language: string): string =>
  '<!-- Auto-generated by `clad init`. Greenfield seed for ' +
  language +
  ' — no code observed yet. Re-run `clad init --scan` after writing\n' +
...
export function renderGreenfieldArchitectureYaml(language: string): string {
  ...
  const lines: string[] = [
    'version: "0.1"',
    '# Auto-generated by `clad init`. Greenfield seed — no import graph',
    '# observed yet. Re-run `clad init --scan` after creating your source',
    '# layout to capture observed layers + forbidden_imports candidates;',
    '# the observed body will divert to',
    '# `.cladding/scan/architecture.yaml.proposal` for review.',
    '#',
...
export function renderGreenfieldCapabilitiesYaml(projectName: string): string {
  const lines: string[] = [
    '# Auto-generated by `clad init`. Greenfield seed — no README ##',
    '# headings observed yet. Re-run `clad init --scan` after writing',
    '# your README; this file will be regenerated from the observed',
    '# headings and the new body will divert to',
