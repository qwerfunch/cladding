...
cladding builds **itself** with cladding too — 291 of its 306 features cleared this same gate, the first L4 implementation of the [Ironclad](https://github.com/qwerfunch/ironclad) standard.
