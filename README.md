...
**stage_1.2 Lint implemented (L3).** Building toward Ironclad L4 (`iron-law: L4, detectors: 19/19, ears: full`) one Lego brick at a time.
...
| L4-L7 | Remaining L1 stages (Drift · Commit · Arch · Secret) + 19 detectors | TBD |
