...
|---|---|---|---|---|
| v0.9.4 worktree · 2026-08 | L4 · [L0–L4 중 최고 · 자가 선언](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3670 / 3670 · all pass | 15 단계 · 41 detectors | 292 · 276 done · 자기 스펙 |

<sub>313 test files · capability 6개 · coverage는 COVERAGE_DROP detector가 하락 차단</sub>
