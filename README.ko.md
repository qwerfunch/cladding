...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-3827%2F3827-brightgreen" alt="tests"/>
...
cladding은 **자기 자신도 cladding으로 만든다** — 기능 303개 중 288개가 같은 게이트를 통과했고, [Ironclad](https://github.com/qwerfunch/ironclad) 표준을 L4로 구현한 첫 사례다.
...
|---|---|---|---|---|
| v0.10.0 · 2026-09 | L4 · [L0–L4 중 최고 · 자가 선언](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3827 / 3827 · all pass | 15 단계 · 41 detectors | 303 · 288 done · 자기 스펙 |

<sub>334 test files · capability 6개 · coverage는 COVERAGE_DROP detector가 하락 차단</sub>
