...
cladding은 **자기 자신도 cladding으로 만든다** — 기능 304개 중 288개가 같은 게이트를 통과했고, [Ironclad](https://github.com/qwerfunch/ironclad) 표준을 L4로 구현한 첫 사례다.
...
|---|---|---|---|---|
| v0.10.0 · 2026-09 | L4 · [L0–L4 중 최고 · 자가 선언](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3835 / 3835 · all pass | 15 단계 · 41 detectors | 304 · 288 done · 자기 스펙 |
