...
cladding은 **자기 자신도 cladding으로 만든다** — 기능 296개 중 290개가 같은 게이트를 통과했고, [Ironclad](https://github.com/qwerfunch/ironclad) 표준을 L4로 구현한 첫 사례다.
...
|---|---|---|---|---|
| v0.9.4 worktree · 2026-08 | L4 · [L0–L4 중 최고 · 자가 선언](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3859 / 3859 · all pass | 15 단계 · 41 detectors | 296 · 290 done · 자기 스펙 |
