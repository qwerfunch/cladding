...
cladding은 **자기 자신도 cladding으로 만든다** — 기능 292개 중 281개가 같은 게이트를 통과했고, [Ironclad](https://github.com/qwerfunch/ironclad) 표준을 L4로 구현한 첫 사례다.
...
|---|---|---|---|---|
| v0.9.4 worktree · 2026-08 | L4 · [L0–L4 중 최고 · 자가 선언](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3721 / 3721 · all pass | 15 단계 · 41 detectors | 292 · 281 done · 자기 스펙 |

<sub>316 test files · capability 6개 · coverage는 COVERAGE_DROP detector가 하락 차단</sub>
