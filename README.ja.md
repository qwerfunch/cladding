...
cladding は **自分自身も cladding で作っている** — 293 個の feature のうち 287 個が同じゲートを通過した、[Ironclad](https://github.com/qwerfunch/ironclad) 標準を L4 で実装した最初の事例だ。
...
|---|---|---|---|---|
| v0.9.4 worktree（2026-08） | L4 · [自己申告](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3790 / 3790 | 15 段階 · 41 detectors | 293（287 done） |
