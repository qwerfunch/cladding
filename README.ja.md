...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-3711%2F3711-brightgreen" alt="tests"/>
...
|---|---|---|---|---|
| v0.9.4 worktree（2026-08） | L4 · [自己申告](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3711 / 3711 | 15 段階 · 41 detectors | 292（276 done） |

<sub>315 test files · capability 6 個 · カバレッジ低下は COVERAGE_DROP detector がブロック</sub>
