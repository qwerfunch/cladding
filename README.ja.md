...
cladding は **自分自身も cladding で作っている** — 295 個の feature のうち 288 個が同じゲートを通過した、[Ironclad](https://github.com/qwerfunch/ironclad) 標準を L4 で実装した最初の事例だ。
...
|---|---|---|---|---|
| v0.9.4 worktree（2026-08） | L4 · [自己申告](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3824 / 3824 | 15 段階 · 41 detectors | 295（288 done） |

<sub>323 test files · capability 6 個 · カバレッジ低下は COVERAGE_DROP detector がブロック</sub>
