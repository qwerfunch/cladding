...
cladding は **自分自身も cladding で作っている** — 303 個の feature のうち 287 個が同じゲートを通過した、[Ironclad](https://github.com/qwerfunch/ironclad) 標準を L4 で実装した最初の事例だ。
...
|---|---|---|---|---|
| v0.10.0（2026-09） | L4 · [自己申告](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3827 / 3827 | 15 段階 · 41 detectors | 303（287 done） |
