...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-3666%2F3666-brightgreen" alt="tests"/>
...
|---|---|---|---|---|
| v0.9.4 worktree（2026-08） | L4 · [自己申告](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3666 / 3666 | 15 段階 · 41 detectors | 292（276 done） |

<sub>312 test files · capability 6 個 · カバレッジ低下は COVERAGE_DROP detector がブロック</sub>
