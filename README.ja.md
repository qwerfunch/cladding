...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-3855%2F3855-brightgreen" alt="tests"/>
...
cladding は **自分自身も cladding で作っている** — 306 個の feature のうち 291 個が同じゲートを通過した、[Ironclad](https://github.com/qwerfunch/ironclad) 標準を L4 で実装した最初の事例だ。
...
|---|---|---|---|---|
| v0.10.1（2026-09） | L4 · [自己申告](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3855 / 3855 | 15 段階 · 41 detectors | 306（291 done） |

<sub>337 test files · capability 6 個 · カバレッジ低下は COVERAGE_DROP detector がブロック</sub>
