...
cladding は **自分自身も cladding で作っている** — 305 個の feature のうち 290 個が同じゲートを通過した、[Ironclad](https://github.com/qwerfunch/ironclad) 標準を L4 で実装した最初の事例だ。
...
|---|---|---|---|---|
| v0.10.0（2026-09） | L4 · [自己申告](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3839 / 3839 | 15 段階 · 41 detectors | 305（290 done） |

<sub>336 test files · capability 6 個 · カバレッジ低下は COVERAGE_DROP detector がブロック</sub>
