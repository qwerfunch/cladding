...
cladding は **自分自身も cladding で作っている** — 298 個の feature のうち 282 個が同じゲートを通過した、[Ironclad](https://github.com/qwerfunch/ironclad) 標準を L4 で実装した最初の事例だ。
...
|---|---|---|---|---|
| v0.9.4 worktree（2026-08） | L4 · [自己申告](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3745 / 3745 | 15 段階 · 41 detectors | 298（282 done） |
