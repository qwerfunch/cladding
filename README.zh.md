...
|---|---|---|---|---|
| v0.9.4 worktree（2026-08） | L4 · [自我声明](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3711 / 3711 | 15 阶段 · 41 检测器 | 292（276 done） |

<sub>315 个测试文件 · 6 项 capability · 覆盖率下降由 COVERAGE_DROP 检测器拦下</sub>
