...
cladding 连**自己**也是用 cladding 造的 —— 297 个 feature 里有 281 个通过了同一道门禁，成为 [Ironclad](https://github.com/qwerfunch/ironclad) 标准的首个 L4 实现。
...
|---|---|---|---|---|
| v0.9.4 worktree（2026-08） | L4 · [自我声明](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3718 / 3718 | 15 阶段 · 41 检测器 | 297（281 done） |
