...
|---|---|---|---|---|
| v0.9.2（2026-07） | L4 · [自我声明](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 2803 / 2803 | 15 阶段 · 41 检测器 | 273（269 done） |

<sub>249 个测试文件 · 6 项 capability · 覆盖率下降由 COVERAGE_DROP 检测器拦下</sub>
