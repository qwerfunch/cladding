...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-3682%2F3682-brightgreen" alt="tests"/>
...
cladding 连**自己**也是用 cladding 造的 —— 292 个 feature 里有 276 个通过了同一道门禁，成为 [Ironclad](https://github.com/qwerfunch/ironclad) 标准的首个 L4 实现。
...
|---|---|---|---|---|
| v0.9.4 worktree（2026-08） | L4 · [自我声明](https://github.com/qwerfunch/ironclad/blob/main/GOVERNANCE.md) | 3682 / 3682 | 15 阶段 · 41 检测器 | 292（276 done） |

<sub>313 个测试文件 · 6 项 capability · 覆盖率下降由 COVERAGE_DROP 检测器拦下</sub>
